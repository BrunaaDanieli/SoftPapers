...
public class ViewCliente extends javax.swing.JDialog {
    ...
    /**
     * @see Construtor usado para visualizar ou alterar um Cliente.
     * @param parent
     * @param modal
     * @param viewPainelControle
     * @param cliente
    ...
    public ViewCliente(java.awt.Frame parent, boolean modal, ViewPainelControle viewPainelControle, Cliente cliente, Boolean alterar) {
        ...
        tfSalario.setText(cliente.getSalarioCliente().toString());
        tfLimite.setText(cliente.getLimiteCliente().toString());
        tfDesconto.setText(cliente.getDescontoCliente().toString());
    ...
    private void initComponents() {
        ...
        try {
            tfNomeCliente.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("**************************************************")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        tfNomeCliente.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tfNomeCliente.setNextFocusableComponent(tfNomeContato);
        ...
        tfCelular.setNextFocusableComponent(tfEndereco);
        ...
        tfEstado.setNextFocusableComponent(tfSalario);
        ...
        tfSalario.setForeground(new java.awt.Color(102, 102, 102));
        tfSalario.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("########.##"))));
        ...
        tfLimite.setForeground(new java.awt.Color(102, 102, 102));
        tfLimite.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("########.##"))));
        tfLimite.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        tfDesconto.setNextFocusableComponent(tfRg);
        ...
        pnClienteLayout.setHorizontalGroup(
            ...
            .addGroup(pnClienteLayout.createSequentialGroup()
                ...
                .addGroup(pnClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tfSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbSalario))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbLimite)
                    .addComponent(tfLimite, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnClienteLayout.createSequentialGroup()
        ...
        pnClienteLayout.setVerticalGroup(
            ...
            .addGroup(pnClienteLayout.createSequentialGroup()
                ...
                .addGroup(pnClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tfLimite, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tfFundacao.setNextFocusableComponent(tfNomeCliente);
                    ...
                    .addGroup(pnPessoaJuridicaLayout.createSequentialGroup()
                        .addGroup(pnPessoaJuridicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(pnPessoaJuridicaLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tfFundacao, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE))
                            .addGroup(pnPessoaJuridicaLayout.createSequentialGroup()
