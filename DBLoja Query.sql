...
-- INSERT INTO
-- -----------------------------------------------------
INSERT INTO `dbloja`.`endereco` (`idEndereco`, `enderecoEndereco`, `cepEndereco`, `complementoEndereco`, `numeroEndereco`, `cidadeEndereco`, `bairroEndereco`, `estadoEndereco`, `criacaoEndereco`, `atualizacaoEndereco`) VALUES ('1', 'rua Cidade Nova', '38000-000', 'casa', '675', 'Uberaba', 'Cidade Nova', 'Minas Gerais', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`contato` (`idContato`, `nomeContato`, `emailContato`, `telefoneContato`, `celularContato`, `criacaoContato`, `atualizacaoContato`) VALUES ('1', 'Bruna Danieli Ribeiro Gon�alves', 'brunabdrg@gmail.com', '(34)3334-2406', '(34)9683-2798', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`pessoa` (`idPessoa`, `tipoPessoa`, `criacaoPessoa`, `atualizacaoPessoa`) VALUES ('1', 'Fisica', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`pessoafisica` (`idPessoaFisica`, `pessoaPessoaFisica`, `cpfPessoaFisica`, `rgPessoaFisica`, `nascimentoPessoaFisica`, `criacaoPessoaFisica`, `atualizacaoPessoaFisica`) VALUES ('1', '1', '000.000.000-00', 'MG00000000', '1994.10.06', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`funcionario` (`idFuncionario`, `pessoaFuncionario`, `contatoFuncionario`, `enderecoFuncionario`, `nomeFuncionario`, `cargoFuncionario`, `usuarioFuncionario`, `senhaFuncionario`, `criacaoFuncionario`, `atualizacaoFuncionario`) VALUES ('1', '1', '1', '1', 'Bruna Danieli', 'Desenvolvedora', 'brunabdrg', '1234', '2015.09.21', '2015.09.21');

INSERT INTO `dbloja`.`pessoa` (`idPessoa`, `tipoPessoa`, `criacaoPessoa`, `atualizacaoPessoa`) VALUES ('2', 'Fisica', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`pessoafisica` (`idPessoaFisica`, `pessoaPessoaFisica`, `cpfPessoaFisica`, `rgPessoaFisica`, `nascimentoPessoaFisica`, `criacaoPessoaFisica`, `atualizacaoPessoaFisica`) VALUES ('2', '2', '000.000.000-00', 'MG00000000', '2015.09.21', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`contato` (`idContato`, `nomeContato`, `emailContato`, `telefoneContato`, `celularContato`, `criacaoContato`, `atualizacaoContato`) VALUES ('2', 'João da Silva', 'joao@gmail.com', '(00)0000-0000', '(00)0000-0000', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`endereco` (`idEndereco`, `enderecoEndereco`, `cepEndereco`, `complementoEndereco`, `numeroEndereco`, `cidadeEndereco`, `bairroEndereco`, `estadoEndereco`, `criacaoEndereco`, `atualizacaoEndereco`) VALUES ('2', 'rua Dujão Silva', '00000-000', 'casa', '10', 'Uberaba', 'Centro', 'Minas Gerais', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`cliente` (`idCliente`, `pessoaCliente`, `contatoCliente`, `enderecoCliente`, `nomeCliente`, `salarioCliente`, `limiteCliente`, `descontoCliente`, `criacaoCliente`, `atualizacaoCliente`) VALUES ('1', '2', '2', '2', 'João Silva', '900.00', '500.00', '5', '2015.09.21', '2015.09.21');

INSERT INTO `dbloja`.`pessoa` (`idPessoa`, `tipoPessoa`, `criacaoPessoa`, `atualizacaoPessoa`) VALUES ('3', 'Juridica', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`pessoajuridica` (`idPessoaJuridica`, `pessoaPessoaJuridica`, `razaoSocialPessoaJuridica`, `nomeFantasiaPessoaJuridica`, `cnpjPessoaJuridica`, `estadualPessoaJuridica`, `municipalPessoaJuridica`, `suframaPessoaJuridica`, `tributoSimplesPessoaJuridica`, `importacaoPessoaJuridica`, `icmsPessoaJuridica`, `fundacaoPessoaJuridica`, `criacaoPessoaJuridica`, `atualizacaoPessoaJuridica`) VALUES ('1', '3', 'maria da silva compania limitada', 'Maria\'s  Bar', '00.000.000/0000-00', '000.000.000.000', '000000000', '000000000', '1', '1', '1', '2015.09.21', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`endereco` (`idEndereco`, `enderecoEndereco`, `cepEndereco`, `complementoEndereco`, `numeroEndereco`, `cidadeEndereco`, `bairroEndereco`, `estadoEndereco`, `criacaoEndereco`, `atualizacaoEndereco`) VALUES ('3', 'rua Damaria Dasilva', '00000-000', 'casa', '55', 'Uberaba', 'Centro', 'Minas Gerais', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`contato` (`idContato`, `nomeContato`, `emailContato`, `telefoneContato`, `celularContato`, `criacaoContato`, `atualizacaoContato`) VALUES ('3', 'Maria da Silva', 'maria@gmail.com', '(00)0000-0000', '(00)0000-0000', '2015.09.21', '2015.09.21');
INSERT INTO `dbloja`.`fornecedor` (`idFornecedor`, `pessoaFornecedor`, `contatoFornecedor`, `enderecoFornecedor`, `nomeFornecedor`, `criacaoFornecedor`, `atualizacaoFornecedor`) VALUES ('1', '3', '3', '3', 'Maria\'s Bar', '2015.09.21', '2015.09.21');

INSERT INTO `dbloja`.`categoria` (`idCategoria`, `descricaoCategoria`, `criacaoCategoria`, `atualizacaoCategoria`) VALUES ('1', 'Material Escolar', '2015.09.21', '2015.09.21');

INSERT INTO `dbloja`.`produto` (`idProduto`, `categoriaProduto`, `fornecedorProduto`, `descricaoProduto`, `codigoProduto`, `custoProduto`, `vendaProduto`, `minimoProduto`, `maximoProduto`, `estoqueProduto`, `criacaoProduto`, `atualizacaoProduto`) VALUES ('1', '1', '1', 'Caderno Tilibra', '00000000000000000000', '5.00', '8.00', '20', '200', '135', '2015.09.21', '2015.09.21');
